Shader "Azure[Sky]/Static Clouds"
{
	SubShader
	{
		...
		Pass
		{
			...
			uniform float     _Azure_StaticCloudInterpolator, _Azure_StaticLowCloudSpeed, _Azure_StaticCloudScattering, _Azure_StaticCloudExtinction, _Azure_StaticCloudDensity;
			...
			float4 frag (v2f Input) : SV_Target
			{
                ...
                // Output
				float3 OutputColor = inScatter + skyLuminance + lowCloudColor + (sunTexture + moonColor + starfield) * lerp(1.0, lowCloudAlpha, saturate(_Azure_StaticCloudOpacity));
